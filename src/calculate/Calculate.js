...
function calcular() {
    ...
    var [carnesH, frangoH, coraH, suinaH, cervH, cachaH, refriH] = [0,0,0,0,0,0,0];
    var [carnesM, frangoM, coraM, suinaM, cervM, cachaM, refriM] = [0,0,0,0,0,0,0];
    ...
    return {
        ...
        aguas: (agua === 0) ? 0 : 
            ((agua/1000) >= 1.5) ? Math.round(agua / 1000) : Math.round(agua / 1000) + 1, // Garrafas
        sucos: (suco === 0) ? 0 :
            ((suco/1000) >= 1.5) ? Math.round(suco / 1000) : Math.round(suco / 1000) + 1, // Garrafas
        energeticos: (energe === 0) ? 0 :
            ((energe/1000) >= 1.5) ? Math.round(energe / 1000) : Math.round(energe / 1000) + 1, // Garrafas
        ...
        tofu: tof, // Unidades
        abacaxi: (abaca === 0) ? 0 : 
            (Math.round(abaca) > abaca) ? Math.round(abaca) : Math.round(abaca) + 1, // Unidades
        carvao: carv, // Pacotes
